class Bottles extends MovableObject {
    ...
    width = 55;
    height = 70;
    static lastBottlesXPos = -1000; // Statische Variable standardmäßig am Anfang = 1500;
    ...
    constructor() {
        ...
        this.x = Bottles.lastBottlesXPos + Math.random() * 100 + Math.random() * 200; // 200  Math.random() liegt zwischen 0 und 1, Zahl zwischen 200 und 700
